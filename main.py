...
# insert picture
user_label = Label(root, image=scissor_img, bg="#f1f1f1")
comp_label = Label(root, image=scissor_img_comp, bg="#f1f1f1")
comp_label.grid(row=1, column=0)
user_label.grid(row=1, column=4)

# scores
playerScore = Label(root, text=0, font=100, bg="#f1f1f1", fg="black")
computerScore = Label(root, text=0, font=100, bg="#f1f1f1", fg="black")
computerScore.grid(row=1, column=1)
playerScore.grid(row=1, column=3)

# indicators
user_indicator = Label(root, font=50, text="PLAYER", bg="#f1f1f1", fg="black")
comp_indicator = Label(root, font=50, text="COMPUTER", bg="#f1f1f1", fg="black")
user_indicator.grid(row=0, column=3)
comp_indicator.grid(row=0, column=1)

# messages
msg = Label(root, font=50, bg="#f1f1f1", fg="black")
